...
<section class="py-16 px-4 lg:px-8 bg-secondary/20">
    <div class="container mx-auto max-w-6xl">
        <div class="text-center mb-8">
            <h2 class="text-2xl md:text-3xl font-bold mb-2"><?= $stats_title ?? 'Our Impact' ?></h2>
        </div>
...
<section class="py-20 px-4 lg:px-8">
    <div class="container mx-auto max-w-6xl">
        <div class="text-center space-y-4 mb-16">
            <h2 class="text-3xl md:text-4xl font-bold"><?= $advantages_title ?? 'What Sets Us <span class="gradient-text">Apart</span>' ?></h2>
...
<section class="py-20 px-4 lg:px-8 bg-secondary/30">
    <div class="container mx-auto max-w-4xl">
        <div class="text-center space-y-4 mb-12">
            <h2 class="text-3xl md:text-4xl font-bold"><?= $benefits_title ?? 'The <span class="gradient-text">Startout AI</span> Advantage' ?></h2>
        </div>
...
<section class="py-20 px-4 lg:px-8">
    <div class="container mx-auto max-w-3xl text-center">
        <h2 class="text-3xl font-bold mb-6"><?= $cta_title ?? 'Ready to Experience the Difference?' ?></h2>
